def query_01(dataset_path, scale):
    ...
    q = pl.scan_csv(f'{dataset_path}/lineitem.csv', try_parse_dates=True)
    (
...
def query_02(dataset_path, scale):
    ...
    region_ds = pl.scan_csv(f'{dataset_path}/region.csv', try_parse_dates=True)
    nation_ds = pl.scan_csv(f'{dataset_path}/nation.csv', try_parse_dates=True)
    supplier_ds = pl.scan_csv(f'{dataset_path}/supplier.csv', try_parse_dates=True)
    part_ds = pl.scan_csv(f'{dataset_path}/part.csv', try_parse_dates=True)
    part_supp_ds = pl.scan_csv(f'{dataset_path}/partsupp.csv', try_parse_dates=True)
...
def query_03(dataset_path, scale):
    ...
    customer_ds = pl.scan_csv(f'{dataset_path}/customer.csv', try_parse_dates=True)
    line_item_ds = pl.scan_csv(f'{dataset_path}/lineitem.csv', try_parse_dates=True)
    orders_ds = pl.scan_csv(f'{dataset_path}/orders.csv', try_parse_dates=True)
...
def query_13(dataset_path, scale):
    ...
    customer_ds = pl.scan_csv(f'{dataset_path}/customer.csv', try_parse_dates=True)
    orders_ds = pl.scan_csv(f'{dataset_path}/orders.csv', try_parse_dates=True).filter(
...
def query_16(dataset_path, scale):
    ...
    part_ds = pl.scan_csv(f'{dataset_path}/part.csv', try_parse_dates=True)
    supplier_ds = (
        pl.scan_csv(f'{dataset_path}/supplier.csv', try_parse_dates=True)
